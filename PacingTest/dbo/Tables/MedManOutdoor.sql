CREATE TABLE [dbo].[MedManOutdoor] (
    ...
    [PeriodCount]                NVARCHAR (255)  NULL,
    [Location]                   NVARCHAR (255)  NULL,
    [EstimatedImpressions]       DECIMAL (18, 2) NULL,
    ...
    [GoogleMapsUrl]              NVARCHAR (255)  NULL,
    ...
    CONSTRAINT [PK_dbo.MedManOutdoor] PRIMARY KEY CLUSTERED ([rID] ASC)
);
