CREATE TABLE [dbo].[MedManOnlineVideoAds] (
    ...
    [PlannedImpressions]         DECIMAL (18, 4) NULL,
    [DeliveredImpressionsToDate] INT             NULL,
    [PlannedClicks]              INT             NULL,
    [Clicks]                     INT             NULL,
    ...
    CONSTRAINT [PK_dbo.MedManOnlineVideoAds] PRIMARY KEY CLUSTERED ([rID] ASC)
);
