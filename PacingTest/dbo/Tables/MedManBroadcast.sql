CREATE TABLE [dbo].[MedManBroadcast] (
    ...
    [PlannedSpots]               INT             NULL,
    [PurchasedSpots]             INT             NULL,
    ...
    CONSTRAINT [PK_dbo.MedManBroadcast] PRIMARY KEY CLUSTERED ([rID] ASC)
);
